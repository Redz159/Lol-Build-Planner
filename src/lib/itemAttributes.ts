...
// only once every selected role is jungle or support. A roles-less "Fill" loadout has no
// qualifying role, so it sees none of the gated categories but keeps Doran's items.
